    ...
    return (
      ...
      >
        ...
        <Modal.Body style={{backgroundColor:"#d191df"}}>
                <EditForm key={props.id} id={props.id} title={props.title} desc={props.desc} image={props.image} pinned={props.pinned} tag={props.tag} />
        </Modal.Body>
      </Modal>
    );
}
...
export default function Note(props){
    ...
    return (
        <div className="col-lg-4 col-md-6 col-xs-12 d-flex justify-content-center" >
            ...
            <Card.Body>
                <Card.Title style={{ padding: "5px" }}><h2 style={{ fontWeight: "900", textAlign: "center" }}>{props.title}</h2></Card.Title>
                <Card.Title style={{ padding: "5px" }}><h4 style={{ fontWeight: "900", textAlign: "center" }}>{props.tag}</h4></Card.Title>
                <Card.Text >
            ...
            <EditFormModal
                ...
                key={props.id} id={props.id} title={props.title} desc={props.desc} image={props.image} pinned={props.pinned} tag={props.tag} 
            />
        </div>   
    )
}
